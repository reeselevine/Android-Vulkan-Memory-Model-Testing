...
public class StoreBuffer extends Fragment {

    @Nullable
    @org.jetbrains.annotations.Nullable
    @Override
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        final View fragmentView = inflater.inflate(R.layout.fragment_store_buffer, container, false);

        TextView description = fragmentView.findViewById(R.id.store_buffer_description);
        description.setText(getResources().getString(R.string.store_buffer_description));

        TestViewObject testViewObject = new TestViewObject();

        testViewObject.testName = "store_buffer";

        testViewObject.explorerProgressLayout = fragmentView.findViewById(R.id.store_buffer_explorerProgressLayout);
        testViewObject.explorerCurrentIterationNumber = fragmentView.findViewById(R.id.store_buffer_explorerCurrentIterationNumber);
        testViewObject.explorerProgressLayout.setVisibility(View.GONE);

        testViewObject.tuningProgressLayout = fragmentView.findViewById(R.id.store_buffer_tuningProgressLayout);
        testViewObject.tuningCurrentConfigNumber = fragmentView.findViewById(R.id.store_buffer_tuningCurrentConfigNumber);
        testViewObject.tuningCurrentIterationNumber = fragmentView.findViewById(R.id.store_buffer_tuningCurrentIterationNumber);
        testViewObject.tuningProgressLayout.setVisibility(View.GONE);

        testViewObject.explorerButton = fragmentView.findViewById(R.id.store_buffer_explorerButton);
        testViewObject.tuningButton = fragmentView.findViewById(R.id.store_buffer_tuningButton);

        testViewObject.explorerResultButton = new ResultButton(fragmentView.findViewById(R.id.store_buffer_explorerResultButton));
        testViewObject.tuningResultButton = new ResultButton(fragmentView.findViewById(R.id.store_buffer_tuningResultButton));
        ...
        testViewObject. explorerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)getActivity()).openExploreMenu("store_buffer", testViewObject);
            }
        });
        testViewObject.explorerResultButton.button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)getActivity()).displayTestResult("store_buffer");
            }
        });
        testViewObject.tuningButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)getActivity()).openTuningMenu("store_buffer", testViewObject);
            }
        });
