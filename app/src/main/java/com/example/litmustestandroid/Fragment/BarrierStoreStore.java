...
public class BarrierStoreStore extends Fragment {
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        Button explorerButton = fragmentView.findViewById(R.id.barrier_store_store_explorerButton);
        Button tuningButton = fragmentView.findViewById(R.id.barrier_store_store_tuningButton);

        ResultButton explorerResultButton = new ResultButton(fragmentView.findViewById(R.id.barrier_store_store_explorerResultButton));
        ResultButton tuningResultButton = new ResultButton(fragmentView.findViewById(R.id.barrier_store_store_tuningResultButton));
        ...
        explorerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((MainActivity)getActivity()).openExploreMenu("barrier_store_store", new Button[]{explorerButton, tuningButton}, new ResultButton[]{explorerResultButton, tuningResultButton});
            }
        });
        ...
        tuningButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)getActivity()).openTuningMenu("barrier_store_store", new Button[]{tuningButton, explorerButton}, new ResultButton[]{tuningResultButton, explorerResultButton});
            }
        });
