...
public class Read extends Fragment {
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        final View fragmentView = inflater.inflate(R.layout.fragment_read, container, false);

        TextView description = fragmentView.findViewById(R.id.read_description);
        description.setText(getResources().getString(R.string.read_description));

        TestViewObject testViewObject = new TestViewObject();

        testViewObject.testName = "read";

        testViewObject.explorerProgressLayout = fragmentView.findViewById(R.id.read_explorerProgressLayout);
        testViewObject.explorerCurrentIterationNumber = fragmentView.findViewById(R.id.read_explorerCurrentIterationNumber);
        testViewObject.explorerProgressLayout.setVisibility(View.GONE);

        testViewObject.tuningProgressLayout = fragmentView.findViewById(R.id.read_tuningProgressLayout);
        testViewObject.tuningCurrentConfigNumber = fragmentView.findViewById(R.id.read_tuningCurrentConfigNumber);
        testViewObject.tuningCurrentIterationNumber = fragmentView.findViewById(R.id.read_tuningCurrentIterationNumber);
        testViewObject.tuningProgressLayout.setVisibility(View.GONE);

        testViewObject.explorerButton = fragmentView.findViewById(R.id.read_explorerButton);
        testViewObject.tuningButton = fragmentView.findViewById(R.id.read_tuningButton);

        testViewObject.explorerResultButton = new ResultButton(fragmentView.findViewById(R.id.read_explorerResultButton));
        testViewObject.tuningResultButton = new ResultButton(fragmentView.findViewById(R.id.read_tuningResultButton));
        ...
        testViewObject.explorerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)getActivity()).openExploreMenu("read", testViewObject);
            }
        });
        ...
        testViewObject.tuningButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)getActivity()).openTuningMenu("read", testViewObject);
            }
        });
