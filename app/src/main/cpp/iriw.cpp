...
namespace iriw {
    ...
    constexpr char *TAG = "MainActivityIriw";
    constexpr char *SHADER_NAME = "iriw.spv";
    constexpr char *OUTPUT_NAME = "iriw_output.txt";
    ...
    const char* testName = "iriw";
    const char* weakBehaviorStr = "r0: 1, r1: 0, r2: 1, r3: 0";
    ...
    public:
        ...
        void checkResult(easyvk::Buffer &testData, easyvk::Buffer &results, easyvk::Buffer &memLocations, ofstream &outputFile) {
            ...
            if (results.load(0) == 1 && results.load(1) == 0 && results.load(2) == 1 && results.load(3) == 0) {
                weakBehavior++;
            } else {
                nonWeakBehavior++;
            }
