...
private:
    ...
    StressAssignmentStrategy stressAssignmentStrategy = CHUNKING;

public:
    void run(ofstream& outputFile) {
        ...
        testFile = "/data/data/com.example.litmustestandroid/files/" + testFile + ".spv";
