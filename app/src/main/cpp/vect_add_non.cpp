...
namespace vect_add_non {

    const int size = 4;

    constexpr char *TAG = "MainActivityVectAddNon";
    constexpr char *FILE_NAME = "vect_add_non.spv";
    constexpr char *OUTPUT_NAME = "vect_add_non_output.txt";
