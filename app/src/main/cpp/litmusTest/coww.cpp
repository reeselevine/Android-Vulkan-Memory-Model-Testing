...
namespace coww {
    ...
    constexpr char *TAG = "MainActivityCoww";
    constexpr char *SHADER_NAME = "coww.spv";
    constexpr char *OUTPUT_NAME = "coww_output.txt";
    ...
    const char *testName = "coww";
    const char *weakBehaviorStr = "x: 1";
    ...
    public:
        ...
        void checkResult(easyvk::Buffer &testData, easyvk::Buffer &results,
            ...
            if (rand() % sampleInterval == 1) {
                outputFile << "x: " << testData.load(memLocations.load(0)) << "\n";
            }
