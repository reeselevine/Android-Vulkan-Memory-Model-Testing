...
namespace kernel_test_non {
    const int size = 4;

    constexpr char *TAG = "MainActivityKernelTestNon";
    constexpr char *FILE_NAME = "kernel_test_non.spv";
    constexpr char *OUTPUT_NAME = "kernel_test_non_output.txt";
